...
res1 = ['Error, death date after birth date for individual with id : @I7@']
res2 = ['Error, death date after birth date for individual with id : @I2@']
res3 = ['Error, death date after birth date for individual with id : @I15@']
res4 = []
